...
import { Radio, Truck, MapPin, ShieldCheck, Clock, CheckCircle2, ArrowRight } from 'lucide-react';
...
export default function ServicesPage() {
  ...
  return (
    <div style={{ paddingTop: 'var(--header-height)', backgroundColor: '#000000', minHeight: '100vh' }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <p style={{ fontSize: '0.875rem', color: '#cccccc', margin: 0 }}>
                          {svc.protocols}
                        </p>
                      </div>
                    </div>

                    {/* Right Column: Handled Components List */}
      ...
      {/* 4. Inspection & Quality Control Feature */}
      <section className="editorial-section" style={{ backgroundColor: '#000000', borderBottom: '1px solid var(--border-hairline)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '4rem', alignItems: 'center' }} className="handling-grid">
            ...
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(2rem, 3.5vw, 3rem)', color: '#ffffff', fontWeight: 300, lineHeight: 1.2, marginBottom: '1.5rem' }}>
                Certified hands on every vital component.
              </h2>
              <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: '2rem' }}>
                Telecommunication equipment is both heavy and electronically sensitive. Our trained ground crews follow strict rigging guidelines, torque specifications, and pre-departure inspections to guarantee damage-free transit to every site.
              </p>
              <Link
                to="/process"
                style={{
      ...
      <section className="editorial-section" style={{ backgroundColor: '#070707' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto' }}>
            ...
            <h2 style={{ fontSize: '2.5rem', color: '#ffffff', fontWeight: 300, margin: '1rem 0 1.25rem' }}>
              Schedule Your Tower Logistics
            </h2>
            <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', marginBottom: '2.5rem' }}>
              Connect directly with our operations desk to coordinate pickup windows, payload requirements, and site deliveries.
            </p>
            <Link
              to="/contact"
              style={{
